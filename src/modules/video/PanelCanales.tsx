...
export function PanelCanales() {
  ...
  return (
    <section aria-label="Tus canales" className="flex min-h-0 w-full flex-col gap-3">
      <div className="flex items-center justify-between px-1">
        <h2 className="text-body font-semibold text-fg">Tus canales</h2>
      ...
      <Reorder.Group
        ...
        aria-label="Canales suscritos, arrastra para reordenar"
      ...
      <Link href="/configuracion#canales" className="rounded-control px-1 text-caption text-accent-text hover:underline">
        Importar, exportar o restaurar canales
      </Link>
    </section>
  );
}
